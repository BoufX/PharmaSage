...
Review.create!(name: "Oussama", comment: "Always a great experience, super fast service!", rating: "4", pharmacy_id: Pharmacy.first.id)
Review.create!(name: "Abdallah", comment: "Satisfied but they could see some improvements in the future.", rating: "3", pharmacy_id: Pharmacy.first.id )
Review.create!(name: "Oumaima", comment: "Awesome service as always!", rating: "5",pharmacy_id: Pharmacy.first.id )
Review.create!(name: "Soumaya", comment: "Not satisfied...", rating: "2", pharmacy_id: Pharmacy.first.id )

Review.create!(name: "Oussama", comment: "Always a great experience, super fast service!", rating: "4", pharmacy_id: Pharmacy.find(2).id)
Review.create!(name: "Abdallah", comment: "Satisfied but they could see some improvements in the future.", rating: "3", pharmacy_id: Pharmacy.find(2).id )
Review.create!(name: "Oumaima", comment: "Awesome service as always!", rating: "5",pharmacy_id: Pharmacy.find(2).id )
Review.create!(name: "Soumaya", comment: "Not satisfied...", rating: "2", pharmacy_id: Pharmacy.find(2).id )

Review.create!(name: "Oussama", comment: "Always a great experience, super fast service!", rating: "4", pharmacy_id: Pharmacy.find(3).id)
Review.create!(name: "Abdallah", comment: "Satisfied but they could see some improvements in the future.", rating: "3", pharmacy_id: Pharmacy.find(3).id )
Review.create!(name: "Oumaima", comment: "Awesome service as always!", rating: "5",pharmacy_id: Pharmacy.find(3).id )
Review.create!(name: "Soumaya", comment: "Not satisfied...", rating: "2", pharmacy_id: Pharmacy.find(3).id )

Review.create!(name: "Oussama", comment: "Always a great experience, super fast service!", rating: "4", pharmacy_id: Pharmacy.find(4).id)
...
Review.create!(name: "Oumaima", comment: "Awesome service as always!", rating: "5",pharmacy_id: Pharmacy.find(4).id )
Review.create!(name: "Soumaya", comment: "Not satisfied...", rating: "2", pharmacy_id: Pharmacy.find(4).id )

Review.create!(name: "Oussama", comment: "Always a great experience, super fast service!", rating: "4", pharmacy_id: Pharmacy.find(5).id)
Review.create!(name: "Abdallah", comment: "Satisfied but they could see some improvements in the future.", rating: "3", pharmacy_id: Pharmacy.find(5).id )
Review.create!(name: "Oumaima", comment: "Awesome service as always!", rating: "5",pharmacy_id: Pharmacy.find(5).id )
Review.create!(name: "Soumaya", comment: "Not satisfied...", rating: "2", pharmacy_id: Pharmacy.find(5).id )

Review.create!(name: "Oussama", comment: "Always a great experience, super fast service!", rating: "4", pharmacy_id: Pharmacy.find(6).id)
Review.create!(name: "Abdallah", comment: "Satisfied but they could see some improvements in the future.", rating: "3", pharmacy_id: Pharmacy.find(6).id )
Review.create!(name: "Oumaima", comment: "Awesome service as always!", rating: "5",pharmacy_id: Pharmacy.find(6).id )
Review.create!(name: "Soumaya", comment: "Not satisfied...", rating: "2", pharmacy_id: Pharmacy.find(6).id )

Review.create!(name: "Oussama", comment: "Always a great experience, super fast service!", rating: "4", pharmacy_id: Pharmacy.find(7).id)
Review.create!(name: "Abdallah", comment: "Satisfied but they could see some improvements in the future.", rating: "3", pharmacy_id: Pharmacy.find(7).id )
Review.create!(name: "Oumaima", comment: "Awesome service as always!", rating: "5",pharmacy_id: Pharmacy.find(7).id )
Review.create!(name: "Soumaya", comment: "Not satisfied...", rating: "2", pharmacy_id: Pharmacy.find(7).id )

Review.create!(name: "Oussama", comment: "Always a great experience, super fast service!", rating: "4", pharmacy_id: Pharmacy.find(8).id)
Review.create!(name: "Abdallah", comment: "Satisfied but they could see some improvements in the future.", rating: "3", pharmacy_id: Pharmacy.find(8).id )
Review.create!(name: "Oumaima", comment: "Awesome service as always!", rating: "5",pharmacy_id: Pharmacy.find(8).id )
Review.create!(name: "Soumaya", comment: "Not satisfied...", rating: "2", pharmacy_id: Pharmacy.find(8).id )

Review.create!(name: "Oussama", comment: "Always a great experience, super fast service!", rating: "4", pharmacy_id: Pharmacy.find(9).id)
Review.create!(name: "Abdallah", comment: "Satisfied but they could see some improvements in the future.", rating: "3", pharmacy_id: Pharmacy.find(9).id )
Review.create!(name: "Oumaima", comment: "Awesome service as always!", rating: "5",pharmacy_id: Pharmacy.find(9).id )
Review.create!(name: "Soumaya", comment: "Not satisfied...", rating: "2", pharmacy_id: Pharmacy.find(9).id )

Review.create!(name: "Oussama", comment: "Always a great experience, super fast service!", rating: "4", pharmacy_id: Pharmacy.find(10).id)
Review.create!(name: "Abdallah", comment: "Satisfied but they could see some improvements in the future.", rating: "3", pharmacy_id: Pharmacy.find(10).id )
Review.create!(name: "Oumaima", comment: "Awesome service as always!", rating: "5",pharmacy_id: Pharmacy.find(10).id )
Review.create!(name: "Soumaya", comment: "Not satisfied...", rating: "2", pharmacy_id: Pharmacy.find(10).id )

Review.create!(name: "Oussama", comment: "Always a great experience, super fast service!", rating: "4", pharmacy_id: Pharmacy.find(11).id)
Review.create!(name: "Abdallah", comment: "Satisfied but they could see some improvements in the future.", rating: "3", pharmacy_id: Pharmacy.find(11).id )
Review.create!(name: "Oumaima", comment: "Awesome service as always!", rating: "5",pharmacy_id: Pharmacy.find(11).id )
Review.create!(name: "Soumaya", comment: "Not satisfied...", rating: "2", pharmacy_id: Pharmacy.find(11).id )

Review.create!(name: "Oussama", comment: "Always a great experience, super fast service!", rating: "4", pharmacy_id: Pharmacy.find(12).id)
Review.create!(name: "Abdallah", comment: "Satisfied but they could see some improvements in the future.", rating: "3", pharmacy_id: Pharmacy.find(12).id )
Review.create!(name: "Oumaima", comment: "Awesome service as always!", rating: "5",pharmacy_id: Pharmacy.find(12).id )
Review.create!(name: "Soumaya", comment: "Not satisfied...", rating: "2", pharmacy_id: Pharmacy.find(12).id )

Review.create!(name: "Oussama", comment: "Always a great experience, super fast service!", rating: "4", pharmacy_id: Pharmacy.find(13).id)
Review.create!(name: "Abdallah", comment: "Satisfied but they could see some improvements in the future.", rating: "3", pharmacy_id: Pharmacy.find(13).id )
Review.create!(name: "Oumaima", comment: "Awesome service as always!", rating: "5",pharmacy_id: Pharmacy.find(13).id )
Review.create!(name: "Soumaya", comment: "Not satisfied...", rating: "2", pharmacy_id: Pharmacy.find(13).id )

Review.create!(name: "Oussama", comment: "Always a great experience, super fast service!", rating: "4", pharmacy_id: Pharmacy.find(14).id)
Review.create!(name: "Abdallah", comment: "Satisfied but they could see some improvements in the future.", rating: "3", pharmacy_id: Pharmacy.find(14).id )
Review.create!(name: "Oumaima", comment: "Awesome service as always!", rating: "5",pharmacy_id: Pharmacy.find(14).id )
Review.create!(name: "Soumaya", comment: "Not satisfied...", rating: "2", pharmacy_id: Pharmacy.find(14).id )
